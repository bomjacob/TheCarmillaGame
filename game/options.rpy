...
init -1 python hide:
    ...
    theme.regal(
        ...
        widget_selected = "#7A75EB",

        ## The color of a disabled widget face.
        disabled = "#252D30",

        ## The color of disabled widget text.
        disabled_text = "#B9B9B9",
    ...
    config.main_menu_music = "sound/music/carmillaintro.ogg"
...
init python:
    ...
    build.executable_name = "TheCarmillaGame"
